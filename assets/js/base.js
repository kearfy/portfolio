...
function initializeLinks() {
    ...
    document.querySelectorAll('a').forEach(link => {
        ...
        //if the link's hostname contains localhost or if it is empty (since this can work without a webserver), it's a target.
        ...
        if (link.getAttribute('nonav') === null && (link.hostname.includes('localhost') || link.hostname == '') && link.getAttribute('target') !== '_blank' && !link.initialized) {
        ...
        if (link.getAttribute('nonav') === null && (link.hostname.includes('localhost') || link.hostname == '') && link.getAttribute('target') === '_blank') {
